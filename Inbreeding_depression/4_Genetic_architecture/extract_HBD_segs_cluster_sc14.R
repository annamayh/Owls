...
load(paste0("./elavanc1/ID_in3K/data/4_ROHs/EntireRsession_All3085_NewNamesCORRECTED_AUTOSAUMES_RP502SNPs_GenPOSplus10_Model13HBDclasses_ss_Super-Scaffold_14.RData"))
...
colnames(m_HBD_segs) <- c(paste0("pr_HBD_Super-Scaffold_14_wind_", 1:seed))


saveRDS(m_HBD_segs,file=paste0("./ahewett/ID_owls/outputs/4_gen_arch/HBD_per_window_10gens/10_gens_HBD_perID_",snp_window_size,"-wind_Super-Scaffold_14.RDS"))
