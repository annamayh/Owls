...
tarsus_df_all=all_pheno_df%>%
  select(RingId, LeftTarsus, FHBD512gen, FuniWE, age_days,GeneticSex,rank, clutch_merge, Observer, year, min_mes, nestboxID, stage, julian_hatchdate, month, CH1903X, CH1903Y)%>% ##keep only pheno info interested in
...
mass_df_all=all_pheno_df%>%
  select(RingId, Mass, FHBD512gen, FuniWE, age_days,GeneticSex,rank, clutch_merge, Observer, year,min_mes, nestboxID, stage, julian_hatchdate, month, CH1903X, CH1903Y)%>% ##remove phenotype info we may not have 
...
bill_df_all=all_pheno_df%>%
  select(RingId, BillLength, FHBD512gen, FuniWE, age_days,GeneticSex,rank, clutch_merge, Observer, year, min_mes, nestboxID, stage,julian_hatchdate, month, CH1903X, CH1903Y)%>% ##remove phenotype info we may not have 
...
wing_df_all=all_pheno_df%>%
  select(RingId, LeftWing, FHBD512gen, FuniWE, age_days,GeneticSex,rank, clutch_merge, Observer, year, min_mes, nestboxID, stage,julian_hatchdate, month, CH1903X, CH1903Y)%>% ##remove phenotype info we may not have 
