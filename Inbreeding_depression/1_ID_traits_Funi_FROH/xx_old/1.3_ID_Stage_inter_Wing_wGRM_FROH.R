...
wing_df$gr_stage=as.factor(wing_df$gr_stage)
...
mod_wing_GRM.Froh <- brm(LeftWing ~  1 + (FHBD512gen*gr_stage)+sex+rank+age_acc+
...
saveRDS(mod_wing_GRM.Froh,file=paste0(scratch,"1.3.ID_Stage_inter_wing_GRM_FROH.RDS"))
